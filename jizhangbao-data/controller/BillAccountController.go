...
func AddBillAccount(params map[string]string) mgresult.Result {
	if !utils.Exists(params, "bookId") {
		return *mgresult.Error(-1, "缺少账本编号参数")
	}
	if !utils.Exists(params, "billAccountName") {
		return *mgresult.Error(-1, "缺少资金账户名称参数")
	}
	return service.AddBillAccount(params["bookId"], params["billAccountName"])
}
...
func UpdateBillAccount(params map[string]string) mgresult.Result {
	if !utils.Exists(params, "bookId") {
		return *mgresult.Error(-1, "缺少账本编号参数")
	}
	...
	return service.UpdateBillAccount(params["bookId"], params["billAccountId"], params["billAccountName"])
}
...
func DeleteBillAccount(params map[string]string) mgresult.Result {
	if !utils.Exists(params, "bookId") {
		return *mgresult.Error(-1, "缺少账本编号参数")
	}
	if !utils.Exists(params, "billAccountId") {
	...
	return service.DeleteBillAccount(params["bookId"], params["billAccountId"])
}
...
func ListBillAccount(params map[string]string) mgresult.Result {
	if !utils.Exists(params, "bookId") {
		return *mgresult.Error(-1, "缺少账本编号参数")
	}
	return service.ListBillAccount(params["bookId"])
}
...
// @Success 200 {string} string	"ok"
// @Router	/account/del [post]
func GetBillAccount(params map[string]string) mgresult.Result {
	if !utils.Exists(params, "bookId") {
		return *mgresult.Error(-1, "缺少账本编号参数")
	}
	if !utils.Exists(params, "billAccountId") {
	...
	return service.GetBillAccount(params["bookId"], params["billAccountId"])
}
