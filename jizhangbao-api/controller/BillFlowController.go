...
func AddBillFlow(params map[string]string) mgresult.AppResult {
	...
	if !utils.Exists(params, "inOut") {
		return mgresult.AppError(-1, "缺少账单收支类型编号参数，1-收入 2-支出")
	}
	...
	return mgresult.NewAppResult(logic.AddBillFlow(params["bookId"], params["billTypeId"], params["billAccountId"], params["customerId"], params["remark"], params["photos"], params["billTime"], inOut, amount))
}
...
func UpdateBillFlow(params map[string]string) mgresult.AppResult {
	if !utils.Exists(params, "bookId") {
		return mgresult.AppError(-1, "缺少账本编号参数")
	}
	...
	return mgresult.NewAppResult(logic.UpdateBillFlow(params["bookId"], params["billId"], params["billTypeId"], params["billAccountId"], params["customerId"], params["remark"], params["photos"], params["billTime"], amount))
}
...
func DeleteBillFlow(params map[string]string) mgresult.AppResult {
	if !utils.Exists(params, "bookId") {
		return mgresult.AppError(-1, "缺少账本编号参数")
	}
	if !utils.Exists(params, "billId") {
	...
	return mgresult.NewAppResult(logic.DeleteBillFlow(params["bookId"], params["billId"]))
}
...
func GetMonthBillFlowPage(params map[string]string) mgresult.AppResult {
	if !utils.Exists(params, "bookId") {
		return mgresult.AppError(-1, "缺少账本编号参数")
	}
	inOut := 0
	...
	return mgresult.NewAppResult(logic.GetMonthBillFlowPage(params["bookId"], params["month"], params["billTypeId"], params["customerId"], inOut))
}
...
func ListTypeBillSummaryByMonth(params map[string]string) mgresult.AppResult {
	if !utils.Exists(params, "bookId") {
		return mgresult.AppError(-1, "缺少账本编号参数")
	}
	if !utils.Exists(params, "inOut") {
	...
	inOut, _ := strconv.Atoi(params["inOut"])
	return mgresult.NewAppResult(logic.ListTypeBillSummaryByMonth(params["bookId"], params["month"], inOut))
}
...
func ListCustomerBillSummaryByMonth(params map[string]string) mgresult.AppResult {
	if !utils.Exists(params, "bookId") {
		return mgresult.AppError(-1, "缺少账本编号参数")
	}
	if !utils.Exists(params, "inOut") {
	...
	inOut, _ := strconv.Atoi(params["inOut"])
	return mgresult.NewAppResult(logic.ListCustomerBillSummaryByMonth(params["bookId"], params["month"], inOut))
}
...
func GetBillFlow(params map[string]string) mgresult.AppResult {
	if !utils.Exists(params, "billId") {
		return mgresult.AppError(-1, "缺少账单编号参数")
	}
	return mgresult.NewAppResult(data.GetBillFlow(params["billId"]))
}
